...
//import datastructures.qPlay;
	...
	public class JDBCMySQLPunts {
	    ...
	    public static ArrayList<qPlay> getQuery()  {      
	        ...
	        ArrayList<qPlay> puntsPlayArray = new ArrayList<qPlay>();
	        
	        String query = "SELECT * FROM punts";
	        try {           
	            ...
	            while (rs.next()) {
	            	...
	            	if(DEBUGMODE) System.out.println(j);
	            		int goForItInt = rs.getInt("play_id");
	            		String tempQuery = "SELECT * FROM plays WHERE id = " + goForItInt;
